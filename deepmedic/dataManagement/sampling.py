...
def load_imgs_of_subject(log,
    ...
    for channel_i in range(n_channels):
        ...
        if path_to_chan != "-":  # normal case, filepath was given.
            channel = load_volume(path_to_chan, normalize_z_zcore=True, interpolation_function='linear')
    ...
    if paths_to_lbls_per_subj is not None:
        ...
        gt_lbl_img = load_volume(path_to_lbl, normalize_z_zcore=False, interpolation_function='nearest-neighbour')
    ...
    if paths_to_masks_per_subj is not None:
        ...
        roi_mask = load_volume(path_to_roi_mask, normalize_z_zcore=False, interpolation_function='nearest-neighbour')
    ...
    if paths_to_wmaps_per_sampl_cat_per_subj is not None:
        ...
        for cat_i in range(n_sampl_categs):
            ...
            wmap_for_this_cat = load_volume(path_to_wmap_for_this_cat, normalize_z_zcore=False, interpolation_function='linear')
